...
class CarteleraFragment : Fragment() {
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Tom y Jerry", "Tom & Jerry", R.drawable.tom_y_jerry, arrayListOf("Animación"), 4.5f, "Jerry se registra en un hotel de Nueva York el día de una boda importante. Esto obliga al dueño a contratar a Tom para deshacerse de Jerry. Su rivalidad comienza y el jugo del gato y el ratón amenaza la estabilidad del hotel y la boda."))
        peliculas.add(Pelicula("Pinocho", "Pinocchio", R.drawable.pinocho, arrayListOf("Fantasía", "Drama") , 4.0f, "Adaptación en vivo de la clásica historia de una marioneta de madera llamada Pinocho que cobra vida y se convierte en un niño de verdad."))
        ...
        peliculas.add(Pelicula("Mujer Maravilla 1984", "Wonder Woman 1984", R.drawable.mujer_maravilla, arrayListOf("Acción"), 4.5f, "En 1984, durante la Guerra Fría, Diana Prince entra en conflicto con dos formidables enemigos: el hombre de negocios de medios de comunicación Maxwell Lord y su amiga convertida en enemiga Bárbara Ann Minerva, mientras se reencuentra con su interés amoroso Steve Trevor."))
        peliculas.add(Pelicula("El Cazador de Monstruos", "The Headhunter", R.drawable.cazador_de_mostruos, arrayListOf("Terror", "Fantasía") , 4.0f, "Un guerrero recorre parajes salvajes montado a caballo, persiguiendo al monstruo que asesinó a su hija. Su sed de venganza es la fuerza motriz de una película construida con muy pocos elementos, minimalista y épica al mismo tiempo, donde la fantasía y el horror encuentran sus encarnaciones más físicas y cruentas."))
